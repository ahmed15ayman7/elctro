...
import { Check, MapPin, StickyNote, User } from "lucide-react";
...
export default function AdminOrderCard({ order, onStatusChange }: Props) {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 border-b border-border/60 bg-gradient-to-br from-muted/50 via-card to-card p-5 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex min-w-0 gap-4">
          ...
          <div className="min-w-0 space-y-1">
            ...
            <p className="truncate text-lg font-semibold tracking-tight text-foreground">{customerName}</p>
            {email ? (
